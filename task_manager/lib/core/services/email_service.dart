...
class EmailService {
  ...
  /// Send email notification when admin assigns a task to a user
  Future<void> sendTaskAssignedNotification({
    ...
    try {
      // Insert email into a queue table for processing
...
Task Manager Team
      ...
      print('Task assignment email queued for $userEmail');
    } catch (e) {
  ...
  /// Send email notification when user completes a task (notify admin)
...
Task Manager Team
      ...
      print('Task completion email queued for $adminEmail');
    } catch (e) {
...
Task Manager Team
      ...
      print('New user credentials email queued for $userEmail');
    } catch (e) {
