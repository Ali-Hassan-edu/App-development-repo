...
class AdminNotificationsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: AdminNotificationList(userId: user.id),
    );
  }
}

class AdminNotificationList extends ConsumerWidget {
  final String userId;

  const AdminNotificationList({super.key, required this.userId});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    print('DEBUG: Building admin notification list for user: $userId');
    ...
    print(
      'DEBUG: Found ${notifications.length} notifications for admin user $userId',
    );
    for (var notification in notifications) {
      print(
        'DEBUG: Admin notification - Title: ${notification.title}, User: ${notification.userId}, Read: ${notification.isRead}',
      );
    }
