    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          ref.invalidate(allUsersProvider); // Changed to allUsersProvider
        },
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Welcome to your administrative command center. Monitor and manage your team\'s productivity.',
                            style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF0D47A1).withValues(alpha: 0.02),
            blurRadius: 10,
            offset: const Offset(0, 4),
          ),
        ],
