...
class AppDrawer extends StatelessWidget {
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    ...
                    child: Icon(Icons.person, color: isDark ? Colors.white : Colors.green, size: 28),
                  ),
                ...
                child: Column(
                  children: [
                    ...
                    _expandGroup(
                      ...
                      text: text,
                      children: [
                        _subItem(context, 'Products', () => onNavigate(AppRoutes.products), text, sub),
                        _subItem(context, 'Categories', () => onNavigate(AppRoutes.categories), text, sub),
                      ],
                    ),
                    ...
                    _expandGroup(
                      ...
                      text: text,
                      children: [
                        _subItem(context, 'Tax', () => onNavigate(AppRoutes.tax), text, sub),
                        _subItem(context, 'Discount', () => onNavigate(AppRoutes.discount), text, sub),
                      ],
                    ),

                    // ✅ REPORTS GROUP (3 screens)
                    _expandGroup(
                      context,
                      ...
                      text: text,
                      children: [
                        _subItem(context, 'Sales Report', () => onNavigate(AppRoutes.salesReport), text, sub),
                        _subItem(context, 'Item Sales Report', () => onNavigate(AppRoutes.itemSalesReport), text, sub),
                        _subItem(context, 'Purchase Report', () => onNavigate(AppRoutes.purchaseReport), text, sub),
                      ],
                    ),
                  ],
                ),
  ...
  Widget _subItem(BuildContext context, String title, VoidCallback onTap, Color text, Color sub) {
    return ListTile(
