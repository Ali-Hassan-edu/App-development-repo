...
class InventoryListScreen extends StatelessWidget {
  ...
  const InventoryListScreen({super.key, required this.onMenuTap});
    ...
    return Container(
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                Icon(Icons.warehouse_outlined, color: titleColor),
                const SizedBox(width: 8),
                Text(
                  'Inventory',
          ...
          const Expanded(
            child: Center(child: Text('Inventory List Screen (Todo)')),
          ),
        ],
      ),
    );
